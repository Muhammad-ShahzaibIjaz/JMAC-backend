...
const updateCampus = async (req, res) => {
  ...
  try {
    ...
    await campus.update({
      ...
      leadConsultantEmail: leadConsultantEmail !== undefined ? leadConsultantEmail : campus.leadConsultantEmail,
      ...
      leadConsultantName: leadConsultantName !== undefined ? leadConsultantName : campus.leadConsultantName,
